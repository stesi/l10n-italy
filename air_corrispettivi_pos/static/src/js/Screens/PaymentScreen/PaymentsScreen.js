odoo.define('air_corrispettivi_pos.PaymentCorrispettivi', function (require) {
'use strict';
    ...
    ajax.loadXML('/air_corrispettivi_pos/static/src/xml/Screens/PaymentScreen/PaymentScreen.xml', qweb);

    class PaymentCorrispettivi extends PaymentScreen {
        constructor() {
            super(...arguments)}
            }
    PaymentCorrispettivi.template = 'PaymentScreen';

    Registries.Component.add(PaymentCorrispettivi);

    return PaymentCorrispettivi;
});
